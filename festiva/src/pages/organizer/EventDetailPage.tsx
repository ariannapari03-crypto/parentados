...
export function EventDetailPage() {
  ...
  return (
    <div style={{ paddingTop: 8, paddingBottom: 8 }}>
      ...
      <div className="fx-card" style={{ padding: 18, display: 'flex', gap: 16, alignItems: 'center', marginBottom: 14 }}>
        ...
        <div style={{ minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <h1 style={{ margin: 0, fontSize: '1.4rem', color: 'var(--ink)' }}>{ev.title || metaLabel(EVENT_TYPES, ev.type, lang)}</h1>
          </div>
      ...
      <button className="fx-btn fx-btn-ghost" onClick={onDelete} disabled={busy} style={{ width: '100%', borderColor: '#d8a3a0', color: '#b3453f' }}>
        {t('eDelete')}
      </button>
    </div>
  )
